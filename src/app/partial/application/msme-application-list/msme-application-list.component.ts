...
export class MsmeApplicationListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['srno', 'applicationNumber', 'application_date', 'applicationYear', 'allocatedQty', 'approval_status', 'AGREMENT', 'SECURITY DEPOSIT'];
  dataSource:any;
  yearArray:any =[];
  filterForm:any;
  totalRows:any;
  ...
  constructor(private fb: FormBuilder,
    ...
    getData() {
      ...
      let checkSubUserTypeId = this.webStorageService.getSubUserType()
      checkSubUserTypeId == 6 ? paramList+='&userId='+this.webStorageService.getUserId():''; // 6 is consumer
